...
sed -e '2s/Light/Education/g' \
    -e '3s/bright themes/ALT Education/g' \
    -e '4s/breeze/orange/g' \
    -i Papirus-Education/index.theme
...
%changelog
* Wed May 04 2022 Kirill Izmestev <felixz@altlinux.org> 20220302-alt2
